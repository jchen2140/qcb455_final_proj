...
print("building pairwise Jaccard similarities between genes...")
# YUBI ASK: how long will this take?
...
print("building adjacency matrix for GLS graph...")
...
print("constructing combined graph...")
...
reduced_dim = 50
sffix = "_GLS01_CO99"
vizdf_filename = "reduced_vizdf{}.csv".format(sffix)
# YUBI NOTE: rename vizdf filename to differentiate from original
# vizdf.tsv file: 2D coordinates of the final gene layout
