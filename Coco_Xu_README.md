...
1. Run gene_pairs.py
   - The script is not in this repo as I did not right it but can be found be found [here](https://github.com/kundajelab/coessentiality/blob/master/gene_pairs.py)
