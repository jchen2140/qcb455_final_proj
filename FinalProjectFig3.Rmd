...
by_complex <- list(
  ...
  Rag_Ragulator = c("RRAGA","RRAGC","VPS39"),
  FLCN      = c("FLCN","FNIP1"),
...
pal <- c(
  ...
  Rag_Ragulator="#92C5DE", Ragulator="#43aa8b", FLCN="#9a3dff",
  TSC="#9b5de5", MTOR="#277da1", `Other`="grey85"
)
...
by_complex <- list(
  ...
  LC3_conj = c("ATG4B","ATG7","ATG3","ATG10","ATG5","ATG12","ATG16L1","WIPI2"),
  Phagophore = c("ATG9A"),
  Lysosome = c("EPG5")
)
...
# Save figure as jpg
ggsave("/Users/cocoxu/Desktop/school/S5/QCB455/projectdata/fig3c.jpg", plot = fig3c, width = 6, height = 4, dpi = 300)
```