...
def load_screens():
    ...
    # Reason: I have pandas 2.3.3, which deprecates squeeze 
    # Load screens
    ...
    # rewrite squeeze
    cell_lines = pd.read_csv('sample_info.csv', index_col='Broad_ID',
                             usecols=['Broad_ID', 'CCLE_name']).squeeze()
    ...
    '''
    # rewrite squeeze
    olfactory_genes = pd.read_csv('olfactory_genes.txt', header=None).squeeze()
